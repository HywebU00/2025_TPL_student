...
window.addEventListener('load', () => {
  ...
  const mpSlider = new Swiper('.mpSlider .swiper', {
    effect: "fade",        // 淡入淡出效果
    fadeEffect: {
      crossFade: true      // 預設 true，切換時前一張逐漸淡出
    },
    // 切換點
    pagination: {
  ...
  //系統公告
   const noticeSlider = new Swiper('.noticeSlider .swiper', {
    // 切換點
    pagination: {
      el: '.noticeSlider .swiperPagination',
    },
    // 切換箭頭
    navigation: {
      nextEl: '.noticeSlider .swiperNext', //自行設定樣式
